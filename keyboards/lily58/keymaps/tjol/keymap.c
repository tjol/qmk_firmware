 ...
 * `-----------------------------------------/       /     \      \-----------------------------------------'
 *                   | LAlt | LGUI |LOWER | /Space  /       \RShift\  |RAISE | BKSP | AltGR|
 *                   |      |      |      |/       /         \      \ |      |      |      |
 *                   `----------------------------'           '------''--------------------'
 */
 ...
 [_QWERTY] = LAYOUT(
  ...
  KC_LSFT,  KC_Z,   KC_X,    KC_C,    KC_V,    KC_B, KC_LBRC,  KC_RBRC,  KC_N,    KC_M,    KC_COMM, KC_DOT,  KC_SLSH,  KC_ENT,
                        KC_LALT, KC_LGUI, MO(_Q_L3), KC_SPC, KC_RSFT, MO(_Q_L2), KC_BSPC, KC_ALGR
),
...
[_Q_L2] = LAYOUT(
  ...
  _______, _______, _______, _______, _______, _______,  _______, _______, _______, _______, _______, _______, _______, _______,
                             _______, _______, MO(_Q_L4),  KC_ENT, _______, _______, _______, _______
),
 ...
 */
[_Q_L3] = LAYOUT(
   KC_GRV, _______, _______, _______, _______, _______,                     KC_NUM, _______, _______, _______, _______, KC_PGUP,
  _______, _______, _______, _______, _______, _______,                    _______,   KC_P7,   KC_P8,   KC_P9, _______, KC_PGDN,
  _______, _______, _______, _______, _______, _______,                    _______,   KC_P4,   KC_P5,   KC_P6, _______, _______,
  _______, _______, _______, _______, _______, _______,MO(_Q_L4), _______, _______,   KC_P1,   KC_P2,   KC_P3, KC_BSLS, _______,
                             _______, _______, _______,  _______, KC_BSPC, MO(_Q_L4),   KC_P0, KC_PDOT
),
 ...
 */
 ...
 [_COLEMAK] = LAYOUT(
  ...
  KC_LSFT,  KC_Z,   KC_X,    KC_C,    KC_D,    KC_V, KC_LBRC,  KC_RBRC,  KC_K,    KC_H,    KC_COMM, KC_DOT,  KC_SLSH,  KC_ENT,
                        KC_LALT, KC_LGUI, MO(_M_L3), KC_SPC, KC_RSFT, MO(_M_L2), KC_BSPC, KC_ALGR
),
...
[_M_L2] = LAYOUT(
  ...
  _______, _______, _______, _______, _______, _______,                    KC_LEFT, KC_DOWN, KC_UP,   KC_RGHT, _______, _______,
  _______, _______, _______, _______, _______, _______,  _______, _______, _______, _______, _______, _______, _______, _______,
                             _______, _______, MO(_M_L4),  KC_ENT, _______, _______, _______, _______
),
...
[_M_L3] = LAYOUT(
  ...
  _______, _______, _______, _______, _______, _______,                    _______,   KC_P7,   KC_P8,   KC_P9, _______, KC_PGDN,
  _______, _______, _______, _______, _______, _______,                    _______,   KC_P4,   KC_P5,   KC_P6, _______, _______,
  _______, _______, _______, _______, _______, _______,MO(_M_L4), _______, _______,   KC_P1,   KC_P2,   KC_P3, KC_BSLS, _______,
                             _______, _______, _______,  _______, KC_BSPC, MO(_M_L4),   KC_P0, KC_PDOT
),
