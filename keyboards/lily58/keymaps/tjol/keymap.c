 ...
 */
 ...
 [_QWERTY] = LAYOUT(
  ...
  KC_BSPC,  KC_Z,   KC_X,    KC_C,    KC_V,    KC_B, KC_LBRC,  KC_RBRC,  KC_N,    KC_M,    KC_COMM, KC_DOT,  KC_SLSH,  KC_ENT,
 ...
 */
 ...
 [_COLEMAK] = LAYOUT(
  ...
  KC_BSPC,  KC_Z,   KC_X,    KC_C,    KC_D,    KC_V, KC_LBRC,  KC_RBRC,  KC_K,    KC_H,    KC_COMM, KC_DOT,  KC_SLSH,  KC_ENT,
                        KC_LALT, KC_LGUI, MO(_L3), KC_SPC, KC_RSFT, MO(_L2), KC_ALGR, KC_ESC
),
...
[_L2] = LAYOUT(
  ...
  _______, _______,    KC_7,    KC_8,    KC_9, _______,                    _______, _______,   KC_UP, _______, _______, KC_F12,
  _______, _______,    KC_4,    KC_5,    KC_6, KC_PDOT,                    _______, KC_LEFT, KC_DOWN, KC_RGHT, _______, _______,
  KC_DEL, _______,    KC_1,    KC_2,    KC_3,    KC_0,  _______, _______, _______, _______, _______, _______, KC_BSLS, _______,
 ...
 */
[_L3] = LAYOUT(
  _______, _______, _______, _______, _______, _______,                     KC_NUM, _______, _______, KC_HOME,  KC_END, KC_PGUP,
  ...
  MO(_L4), _______, _______, _______, _______, _______, _______, _______, _______,   KC_P1,   KC_P2,   KC_P3, KC_BSLS, _______,
                             _______, _______, _______, _______,  RSFT_T(KC_BSPC), XXXXXXX,   KC_P0, KC_PDOT
),
