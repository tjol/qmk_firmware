 ...
 */
 ...
 [_COLEMAK] = LAYOUT(
  ...
  KC_LSFT,  KC_Z,   KC_X,    KC_C,    KC_D,    KC_V, KC_ESC,   KC_BSPC,  KC_K,    KC_H,    KC_COMM, KC_DOT,  KC_SLSH, KC_ENT,
                        KC_LALT, KC_LGUI, MO(_L3), KC_SPC, KC_RSFT, MO(_L2), KC_ALGR, KC_BSLS
),
 ...
 */
 ...
 [_QWERTY] = LAYOUT(
  ...
  KC_LSFT,  KC_Z,   KC_X,    KC_C,    KC_V,    KC_B, KC_ESC,   KC_BSPC,  KC_N,    KC_M,    KC_COMM, KC_DOT,  KC_SLSH,  KC_ENT,
                        KC_LALT, KC_LGUI, MO(_L3), KC_SPC, KC_RSFT, MO(_L2), KC_ALGR, KC_BSLS
),
...
[_L2] = LAYOUT(
  ...
  _______, _______,    KC_1,    KC_2,    KC_3,    KC_0,  _______, KC_DEL,  _______, _______, _______, _______, KC_BSLS, _______,
