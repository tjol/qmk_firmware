 ...
 * `-----------------------------------------/       /     \      \-----------------------------------------'
 *                   | LAlt | LGUI |LOWER | /Space  /       \RShift\  |RAISE | AltGr|  \   |
 *                   |      |      |      |/       /         \      \ |      |      |      |
 *                   `----------------------------'           '------''--------------------'
 */
 ...
 [_COLEMAK] = LAYOUT(
  ...
  KC_LSFT,  KC_Z,   KC_X,    KC_C,    KC_D,    KC_V, KC_GRV,   KC_BSLS,  KC_K,    KC_H,    KC_COMM, KC_DOT,  KC_SLSH, KC_ENT,
                        KC_LALT, KC_LGUI, MO(_L3), KC_SPC, KC_RSFT, MO(_L2), KC_ALGR, KC_INS
),
...
[_L2] = LAYOUT(
  ...
  _______, _______,    KC_7,    KC_8,    KC_9, _______,                     KC_PGUP, KC_HOME,   KC_UP,  KC_END, _______, KC_F12,
  _______, _______,    KC_4,    KC_5,    KC_6,  KC_DOT,                     KC_PGDN, KC_LEFT, KC_DOWN, KC_RGHT, _______, _______,
  _______, _______,    KC_1,    KC_2,    KC_3,    KC_0,  _______, TG(_L2), _______, _______, _______, _______, KC_BSLS, _______,
                             _______, _______, _______, LSFT_T(KC_BSPC), _______, _______, _______, _______
),
...
QK_REBOOT, XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX,                            XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX,
  ...
  XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX,                            XXXXXXX,  KC_NUM, XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX,
