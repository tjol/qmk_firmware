...
[_Q_L2] = LAYOUT(
  ...
  _______, _______, _______, _______, _______, _______,  _______, _______, _______, _______, _______, _______, _______, _______,
                             _______, _______, MO(_Q_L4), KC_BSPC, _______, _______, KC_DEL, _______
),
 ...
 */
[_Q_L3] = LAYOUT(
   KC_GRV, _______, _______, _______, _______, _______,                     KC_NUM, _______, _______, KC_HOME,  KC_END, KC_PGUP,
  ...
  _______, _______, _______, _______, _______, _______,MO(_Q_L4), _______, _______,   KC_P1,   KC_P2,   KC_P3, KC_BSLS, _______,
                             _______, _______, _______,  _______, KC_ENT, MO(_Q_L4),   KC_P0, KC_PDOT
),
...
[_M_L2] = LAYOUT(
  ...
  _______, _______, _______, _______, _______, _______,                    KC_LEFT, KC_DOWN, KC_UP,   KC_RGHT, _______, _______,
  _______, _______, _______, _______, _______, _______,  _______, _______, _______, _______, _______, _______, _______, _______,
                             _______, _______, MO(_M_L4), KC_BSPC, _______, _______, KC_DEL, _______
),
...
[_M_L3] = LAYOUT(
  ...
  _______, _______, _______, _______, _______, _______,MO(_M_L4), _______, _______,   KC_P1,   KC_P2,   KC_P3, KC_BSLS, _______,
                             _______, _______, _______,  _______,  KC_ENT, MO(_M_L4),   KC_P0, KC_PDOT
),
