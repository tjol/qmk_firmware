 ...
 * `-----------------------------------------/       /     \      \-----------------------------------------'
 *                   | LAlt | LGUI | NAV  | /Space  /       \RShift\  | SYM  | AltGr| Func |
 *                   |      |      |      |/       /         \      \ |      |      |      |
 *                   `----------------------------'           '------''--------------------'
 */
 ...
 [_COLEMAK] = LAYOUT(
  ...
  KC_LSFT,  KC_Z,   KC_X,    KC_C,    KC_D,    KC_V, KC_GRV,   KC_BSLS,  KC_K,    KC_H,    KC_COMM, KC_DOT,  KC_SLSH, KC_ENT,
                        KC_LALT, KC_LGUI, TT(_NAV), KC_SPC, KC_RSFT, TT(_SYM), KC_ALGR, MO(_FN)
),
...
[_NAV] = LAYOUT(
   KC_ESC, _______, _______, _______, _______, MO(_SYS),                    _______, _______, _______, _______, _______, KC_DEL,
  _______, _______,    KC_7,    KC_8,    KC_9, _______,                     KC_PGUP, KC_HOME,   KC_UP,  KC_END, _______, KC_INS,
  _______, _______,    KC_4,    KC_5,    KC_6,  KC_DOT,                     KC_PGDN, KC_LEFT, KC_DOWN, KC_RGHT, _______, _______,
  _______, _______,    KC_1,    KC_2,    KC_3,    KC_0,  _______, _______, _______, _______, _______, _______, KC_BSLS,  KC_PSCR,
